...
flowchart TD
    ...
    pr -->|Description corrected, no new commit| review
    ...
    review -->|Verified review of captured request| consumed["Agentic: remove factory-review-requested<br/>Identity: Actions"]
...
or close issues. Description edits and one-shot review requests allow fresh
